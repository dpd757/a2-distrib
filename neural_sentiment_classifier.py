...
def _parse_args():
    ...
    parser.add_argument('--dev_typo_path', type=str, default='data/dev-typo.txt',
                        help='path to dev set with typos (you should not need to modify)')
...
if __name__ == '__main__':
    ...
    if args.use_typo_setting:
        ...
        dev_typo_exs = read_sentiment_examples(args.dev_typo_path)
